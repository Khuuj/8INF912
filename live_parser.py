...
from live_packets import LivePacketTree
from live_player import LivePlayerManager
...
class LiveLogParser(LogParser):
	...
	def handle_options(self, ts, data):
		super(LiveLogParser, self).handle_options(ts, data)
		if data.startswith("id="):
	...
	def register_packet(self, packet, node=None):
		...
		#if (packet.__class__.__name__ == "Option"):
		#	print("qlsrjklzer")
